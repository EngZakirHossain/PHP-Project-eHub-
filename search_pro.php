...
extract($_POST);
$sql_search=mysql_query("select * from products where pname Like '%$search%' and pstatus='Published'") or die(mysql_error());
?>
?>
				...
				<div class="shell">
					...
					<div id="content">
						...
						<div id="products">
							...
							while($data_sp=mysql_fetch_array($sql_search))
							{
							?>
                            <div class="product">
								<a href="view_pro.php<?php echo "?viewpid=$data_sp[pid]" ?>" title="<?php echo $data_sp['pname']; ?>">
									<span class="title"><?php echo $data_sp['pname']; ?></span>
									<img src="admin/image/<?php echo  $data_sp['image']; ?>" alt="Product Image 1" />
									<span class="number">Product &nbsp; <?php echo $serial;?></span>
									<span class="price"><span>Tk.</span><?php echo  $data_sp['price']; ?></span>
								</a>
							</div>
                            <?php 
							$serial++;
