...
if($acat!="" and $aid!="" and $aname!="" and $astatus=="Published")
{
	...
	$mid=$_GET['menuid'];
	$sql_menu=mysql_query("select * from menu where mid='$mid'");
	$data_menu=mysql_fetch_array($sql_menu);
?>
<!DOCTYPE html>
<html >
<head>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            ...
            <table width="50%" border="0" cellspacing="0" cellpadding="5" style="border:1px solid #7ac143;">
              <tr>
                <td height="40" colspan="3" style="background-color:#7ac143; text-align:center; font-size:18px; color:#333;"><strong>Edit Menu</strong></td>
              </tr>
              <tr>
                ...
                <td width="55%" align="left" valign="middle"><input name="mname" type="text" id="mname" size="40" value="<?php echo $data_menu['mname']; ?>"/></td>
              </tr>
              <tr>
                <td width="40%" align="left" valign="middle" style="padding-left:15px;"><strong>Menu Link</strong></td>
                <td width="5%" align="center" valign="middle"><strong>:</strong></td>
                <td width="55%" align="left" valign="middle"><input name="mlink" type="text" id="mlink" size="40" value="<?php echo $data_menu['mlink']; ?>"/></td>
              </tr>
              <tr>
                ...
                <td width="55%" align="left" valign="middle"><select name="mcat" id="mcat">
                  ...
                  <option value="Superadmin" <?php if($data_menu['mcategory']=='Superadmin'){ echo "selected";}?>>Superadmin</option>
                  <option value="Superadmin+admin" <?php if($data_menu['mcategory']=='Superadmin+admin'){ echo "selected";}?>>Superadmin+admin</option>
                </select></td>
              </tr>
              <tr>
                ...
                <td width="55%" align="left" valign="middle"><select name="mstatus" id="mstatus">
                  <option value="Published" <?php if($data_menu['mstatus']=='Published'){ echo "selected";}?>>Published</option>
                  <option value="Unpublished" <?php if($data_menu['mstatus']=='Unpublished'){ echo "selected";}?>>Unpublished</option>
                </select></td>
              </tr>
              
              <tr>
                <td colspan="3" align="center" valign="middle" style="padding-left:15px;"><input type="reset" name="Reset" id="button" value="Reset" />
                  <input type="submit" name="submit" id="submit" value="Edit Menu" />
                  <input type="hidden" name="hiddenid" id="hiddenid" value="<?php echo $data_menu['mid']; ?>" /></td>
                </tr>
            </table>
            </form>
