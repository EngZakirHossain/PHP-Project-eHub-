...
if($acat!="" and $aid!="" and $aname!="" and $astatus=="Published")
{
	...
	if($deleteaid)
	{
		mysql_query("delete from category where cid='$deleteaid'");
...
<title>E-Hub Admin Panell</title>
</head>
<style type="text/css">
body{
	margin:0;
...
function deleteAdmin(delaid)
{
   ...
   if (res){
   window.location="cat_manage.php?delidno="+delaid;
   }
}
</script>
<body>
          ...
          <tr>
            ...
            <table width="50%" border="0" cellspacing="0" cellpadding="5" style="border:1px solid #7ac143;">
              ...
              <tr>
                ...
                <td width="55%" align="left" valign="middle"><input name="cname" type="text" required="required" id="cname" size="40" /></td>
              </tr>
              ...
              <tr>
                <td colspan="3" align="center" valign="middle" style="padding-left:15px;"><input type="reset" name="Reset" id="button" value="Reset" />
                  <input type="submit" name="submit" id="submit" value="Add Category" /></td>
                </tr>
            </table>
            </form>
            <p>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="5" style="border:1px solid #7ac143;">
			  ...
			  while($data_cat=mysql_fetch_array($sql))
			  
			  {
			  ?>
              <tr>
                <td width="10%" align="center" valign="middle"><?php echo $serial; ?></td>
                <td width="20%" align="left" valign="middle"> <?php  echo $data_cat['cname'];?></td>
                <td width="20%" align="center" valign="middle"><?php  echo $data_cat['cstatus'];?></td>
                <td width="9%" align="center" valign="middle"><a href="cat_edit.php<?php echo "?catid=$data_cat[cid]"; ?>"> Edit</a></td>
                <td width="9%" align="center" valign="middle"><?php echo "<a href=\"javascript:deleteAdmin(delaid=$data_cat[cid])\">Delete</a>";?></td>
              </tr>
              <?php
			  $serial++; 
			  }
