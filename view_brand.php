...
$pbrand=$_GET['pbrand'];
$sql_view_brand1=mysql_query("select * from products where pstatus='Published' and brand='$pbrand'") or die(mysql_error());
...
<html>
<head>
	<title> All <?php echo $pbrand ?> Brand</title>
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						...
						<!-- Begin Products -->
						<div id="products">
							<h2> All <?php echo $pbrand; ?> Brand<span class="title-bottom">&nbsp;</span></h2>
							<?php 
							$serial=1;
							
							while($data_view_brand1=mysql_fetch_array($sql_view_brand1))
							{
							?>
                            <div class="product"> 
								<a href="view_pro.php<?php echo "?viewpid=$data_view_brand1[pid]"; ?>" title="<?php echo $data_view_brand1['pname']; ?>">
									<span class="title"><?php echo $data_view_brand1['pname']; ?></span>
									<img src="admin/image/<?php echo $data_view_brand1['image']; ?>" alt="Product Image 1" />
									<span class="number">Product &nbsp; <?php echo $serial;?></span>
									<span class="price"><span>Tk.</span><?php echo $data_view_brand1['price']; ?></span>
								</a>
							</div>
                            <?php 
							$serial++;
