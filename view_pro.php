...
$viewpid=$_GET['viewpid'];
$sql_view_pro=mysql_query("select * from products where pstatus='Published' and pid='$viewpid'") or die(mysql_error());
$data_view_pro=mysql_fetch_array($sql_view_pro);
...
<body>
	...
	<div id="wrapper">
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						...
						<!-- Begin Products -->
						<div id="products">
							<h2>View Products<span class="title-bottom">&nbsp;</span></h2>
							
                                <div class="pro-img"> 
                                    <div class="imgbox"> 
                                    <a href="admin/image/<?php echo $data_view_pro['image']; ?>" data-lightbox="image-1" title="<?php echo $data_view_pro['pname']; ?>"><img src="admin/image/<?php echo $data_view_pro['image']; ?>"  /></a>
                                    
                                    </div>
                                    <div class="boxpro"> 
                                    
                                        <h2> <?php echo $data_view_pro['pname']; ?></h2>
                                        <p> We are providing a great choice of different commodities. We are producing reliable and durable goods</p>
                                        <br/><br/>
                                        Price Tk. <?php echo $data_view_pro['price']; ?>
                                        <br/><br/>
                                        <br/>
                                ...
                                <h2  style="color:#000; padding:10px 0px; margin:10px 0px;"> Description: </h2> 
                                <p> <?php echo $data_view_pro['description']; ?> </p><br/>
                                <h3> Delivery and Payment Process: </h3> <br/>
                                <ul style="padding-left:15px;">
                                <li> FREE Home Delivery All over Bangladesh.</li>
                                 <li> Cash on Delivery (COD) is applicable only for Dhaka City area; if you want to get Home Delivery outside Dhaka City, please, Pay in Advance; you can pay in advance by your VISA, MasterCard, DBBL debit/credit card or by bKash.</li>
                                 <li> In case of Delivery outside Dhaka, customers have to collect the Product from the nearby Continental Courier Service Office.</li>
                                </ul>
		...
		<div id="footer">
			<div class="shell">
				<p style="text-align:left; float:left; font-size:14px; color:#000; padding-left:150px;">Copyright &copy; E-HUB.com. Design & Developed by: ABZ Group. All Rights Reserved. </p>
				<div class="cl">&nbsp;</div>
			</div>
		</div>
		<!-- End Footer -->
