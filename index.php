	...
	<div id="wrapper">
		...
		<div id="navigation">
			<div class="shell">
				...
				<ul>
					<li style="float: right;" "><a href="login.html" title="Contact">Login</a></li>
					<li style="float: right;" "><a href="register.html" title="Contact">SingUp</a></li>
				</ul>
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						<!-- Begin Post -->
						<div class="post">
							<h2>Welcome to E-HUB<span class="title-bottom">&nbsp;</span></h2>							
							<p>Welcome to E-Hub ...Here you can find all kinds of electronic assesories and low price and 2 year service.You can also buy products with debit and creadit card...and Emi facility also  </p>
						</div>
						<!-- End Post -->
						<!-- Begin Products -->
						<div id="products">
							...
							<?php 
							$serial=1;
							$sql_lp=mysql_query("select * from products where specialcat='Latest Product' and pstatus='Published' ");
							while($data_lp=mysql_fetch_array($sql_lp))
							{
							?>
                            <div class="product">
								<a href="view_pro.php<?php echo "?viewpid=$data_lp[pid]" ?>" title="<?php echo $data_lp['pname']; ?>">
									<span class="title"><?php echo $data_lp['pname']; ?></span>
									<img src="admin/image/<?php echo $data_lp['image']; ?>" alt="Product Image 1" />
									<span class="number">Product &nbsp; <?php echo $serial;?></span>
									<span class="price"><span>Tk.</span><?php echo $data_lp['price']; ?></span>
								</a>
							</div>
                            <?php 
							$serial++;
